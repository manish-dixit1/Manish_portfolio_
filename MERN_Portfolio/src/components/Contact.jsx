      ...
      <div className="flex flex-col-reverse gap-10 overflow-hidden md:mt-12 md:flex-row ">
        ...
        >
          ...
          <div className="flex-center-center mt-8 flex-wrap gap-2">
            <div>
              <a href="mailto:manish.singh0617@gmail.com">
            ...
            <div>
              <a
                href="https://www.linkedin.com/in/manish-kumar-143a6114b/"
                target="_blank"
            ...
            <div>
              <a
                href="https://github.com/manish-dixit1"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="mb-4 ml-5">
        ...
        <div>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://docs.google.com/document/d/1rM4mGIxw8nMfKoY82qZDA7Er98OwKAUKLP3E0i-D5aY/edit?usp=sharing"
          >
